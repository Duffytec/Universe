...
QuadtreeTerrainFace::QuadtreeTerrainFace(const QuadtreeTerrain *terrain, const unsigned int faceType,
                                         const double positionZ)
        : terrain(terrain), faceType(faceType), positionZ(positionZ), topNode(new QuadtreeTerrainNode(this)),
          splitsRemaining(0) {
